...
```
vendor/bin/phpunit tests/unit/Espo/Modules/EspoTestPlugin2
```
...
```
vendor/bin/phpunit tests/integration/Espo/Modules/EspoTestPlugin2
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/EspoTestPlugin2`
* `site/tests/integration/Espo/Modules/EspoTestPlugin2`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/EspoTestPlugin2/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/EspoTestPlugin2/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/espo-test-plugin2/lib/init.js"
        ]
    }
    ```
